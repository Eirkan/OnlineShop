...
namespace Order.Core.Extensions
{
    /// <summary>
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Gelen değeri MD5 formata çevirir.
        /// </summary>
        ...
        /// <summary>
        /// Banka kart numarasını Legal formata çevirerek geri döner. Örnek: 1111-1111-1111-1111 => 1111-11**-****-1111
        /// </summary>
        public static string ToLegalCardFormat(this string cardNumber)
        {
        ...
        /// <summary>
        /// Gönderilen TCKN bilgisinin geçerli olup olmadığını kontrol eder.
        /// </summary>
        public static bool IsValidTCKN(this string tckNo)
        {
            ulong num;
        ...
        /// <summary>
        /// Gelen değeri arama motoru için uygun şekilde url yaparak geri döner.
        /// </summary>
